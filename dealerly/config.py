...
DB_PATH: Path = DATA_DIR / "dealerly.db"
...
DEFAULT_RESALE_DISCOUNT: float = 0.97
...
USER_AGENT: str = os.environ.get(
    "DEALERLY_USER_AGENT",
    "Dealerly/0.9.9 (+https://swautosuk.com)",
)
VERSION: str = "0.9.9"
...
ENABLED_PLATFORMS: list = ["ebay", "motors", "facebook"]  # Facebook adapter self-checks Playwright/cookies
