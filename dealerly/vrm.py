...
_LABEL_PATTERN = re.compile(
    ...
    # very common in eBay free-text descriptions ("the reg is AB12CDE",
    # "current reg AB12CDE") that the colon-style pattern misses.
...
def vrm_year_plausible(vrm: str, listing_year: Optional[int], tolerance: int = 6) -> bool:
    """
    Return True if the plate's implied registration year is within `tolerance`
    years of the listing's stated year.
    ...
    Returns False when mismatch > tolerance — strong signal of wrong-car plate.
    """
